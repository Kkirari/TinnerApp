...
import { PasswordValidator } from '../_validators/password-validater'
    ...
    switch (ctrlName) {
      ...
      case 'password':
        if (control.hasError('required'))
          ...
          this.errorMessages.password.set('must contain minimum of one lower-case letter')
        else if (control.hasError('inValidUppercase'))
          this.errorMessages.password.set('must contain minimum of one Upper-case letter')
        else if (control.hasError('inValidNumber'))
          this.errorMessages.password.set('must contain minimum of one numeric character')
        else if (control.hasError('inValidSpecialCharacter'))
          this.errorMessages.password.set('must contain minimum of one special character')
        else
